        ...
        <div class="email-content">
            <div class="email-content-header pure-g">
                <div class="pure-u-1-2">
                    <h1 class="email-content-title">What's Wrong?</h1>
                    <p class="email-content-subtitle">
                        Created by: <a>XXX </a> at <span>3:56pm, April 3, 2014</span>
                    </p>
                </div>

                <div class="email-content-controls pure-u-1-2">
                    <button class="secondary-button pure-button">Need Help!</button>
                </div>
            </div>
